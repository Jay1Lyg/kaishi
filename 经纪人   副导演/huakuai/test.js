/**
 * Created by Carry on 11/23/2017.
 */
(function(){
    ...
    function Slide(height,width,blockCount,descriptions,cursorUnit){
        ...
        //定义颜色
        this.colors=['#4da2ad','red','blue','#00E3E3','#F9F900','#8600FF','#0000C6','#28FF28','#FF8000','#000079','#009100','#3A006F','#FF2D2D','#7B7B7B','#642100','#484891','#336666','#FFFF37','#600030','#003E3E','#red'];
    ...
    new Slide(15,600,6,['知识点1','知识点2','知识点3','知识点4','知识点5','知识点6'],8).addListener();
})();