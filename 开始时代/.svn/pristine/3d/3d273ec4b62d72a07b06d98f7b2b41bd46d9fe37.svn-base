		                                    	...
		                                    	ret2.save(function(err){
		                                    	 if(is_click == true){
			                                          if(index=='1'){
											               ...
											               var url='/agent/a_page_actorList/'+user._id+'/'+req.body.appid;
											               res.redirect(url);
														}if(index=='3'){
														   var url = '/agent/a_page_agent_InvitationRecords/'+user._id;
														   res.redirect(url);											               
														}if(index=='4'){
											               var url = '/agent/a_page_agent_applyCrewRecords/'+user._id;
											               res.redirect(url);
														}if(index=='5'){
											               var url='/agent/a_page_actorManage/'+user._id+'/'+req.body.appid;
											               res.redirect(url);
														}if(index=='6'){
															var url = '/agent/a_page_addNewActors/'+user._id+'/'+req.body.appid;
										               		res.redirect(url);						
														}
														// if(index=='7'){
